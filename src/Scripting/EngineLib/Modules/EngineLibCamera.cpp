...
void Scripting::EngineLib::register_camera_modules(ObSL::Interpreter &interpreter) {
    interpreter.get_global_environment()->define("Camera_GetPosition", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                               0,
    ...
    interpreter.get_global_environment()->define("Camera_SetPosition", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                               3,
                                                                               [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &args) -> ObSL::Value {
                                                                                   if (ctx && ctx->camera && args.size() >= 3 && std::holds_alternative<double>(args[0]) && std::holds_alternative<double>(args[1]) &&
    ...
    interpreter.get_global_environment()->define("Camera_Move", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                        3,
                                                                        [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &args) -> ObSL::Value {
                                                                            if (ctx && ctx->camera && args.size() >= 3 && std::holds_alternative<double>(args[0]) && std::holds_alternative<double>(args[1]) &&
                                                                                std::holds_alternative<double>(args[2])) {
    ...
    interpreter.get_global_environment()->define("Camera_PanScreenSpace", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                                  2,
                                                                                  [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &args) -> ObSL::Value {
    ...
    interpreter.get_global_environment()->define("Camera_GetZoom", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                           0,
    ...
    interpreter.get_global_environment()->define("Camera_SetZoom", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                           1,
                                                                           [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &args) -> ObSL::Value {
    ...
    interpreter.get_global_environment()->define("Camera_GetAngleX", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                             0,
                                                                             [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &) -> ObSL::Value {
                                                                                 if (ctx && ctx->camera) {
                                                                                     std::lock_guard lock(s_CameraMutex);
    ...
    interpreter.get_global_environment()->define("Camera_GetAngleZ", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                             0,
                                                                             [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &) -> ObSL::Value {
                                                                                 if (ctx && ctx->camera) {
                                                                                     std::lock_guard lock(s_CameraMutex);
    ...
    interpreter.get_global_environment()->define("Camera_SetAngle", interpreter.gc.allocate<ObSL::NativeFunction>(
                                                                            2,
                                                                            [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &args) -> ObSL::Value {
                                                                                if (ctx && ctx->camera && args.size() >= 2 && std::holds_alternative<double>(args[0]) && std::holds_alternative<double>(args[1])) {
                                                                                    std::lock_guard lock(s_CameraMutex);
