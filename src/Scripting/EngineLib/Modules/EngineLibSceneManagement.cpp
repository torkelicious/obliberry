...
void Scripting::EngineLib::register_scene_management_modules(ObSL::Interpreter &interpreter) {
    interpreter.get_global_environment()->define("LoadScene",
            interpreter.gc.allocate<ObSL::NativeFunction>(1, // scene file path
    ...
    interpreter.get_global_environment()->define("GetCurrentScenePath", interpreter.gc.allocate<ObSL::NativeFunction>(0, [ctx = m_ctx](ObSL::Interpreter *, const std::vector<ObSL::Value> &) -> ObSL::Value {
