...
namespace Rendering::MeshFactory {
    ...
    MeshData CreateRegularPolygon(unsigned int sides = 3, float radius = 0.5);

    MeshData CreateRing(float innerRadius = 0.25, float outerRadius = 0.5, unsigned int segments = 50);
