...
#pragma pack(push, 1)
    struct MapFileHeader {
        ...
        uint16_t version = Core::MAP_FILE_VERSION;                // format may change so good to have
...
#pragma pack(pop)
    ...
    static bool CheckHeader(const MapFileHeader &header, const std::string_view &expected);
