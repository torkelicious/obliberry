...
bool Core::InputManager::IsKeyPressed(const int key) const { return IsValidKey(key) && keys[key] && !previousKeys[key]; }

bool Core::InputManager::IsKeyPressed(const std::string &KeyAlias) const { return IsKeyPressed(GetKeyFromName(KeyAlias)); }

bool Core::InputManager::IsKeyReleased(const int key) const { return IsValidKey(key) && !keys[key] && previousKeys[key]; }

bool Core::InputManager::IsKeyReleased(const std::string &keyAlias) const { return IsKeyReleased(GetKeyFromName(keyAlias)); }
...
bool Core::InputManager::IsValidMouseButton(const int button) { return button >= 0 && button <= GLFW_MOUSE_BUTTON_LAST; }
...
bool Core::InputManager::IsMouseDown(const int button) const { return IsValidMouseButton(button) && mouseButtons[button]; }

bool Core::InputManager::IsMouseDown(const std::string &buttonAlias) const { return IsMouseDown(GetKeyFromName(buttonAlias)); }

bool Core::InputManager::IsMousePressed(const int button) const { return IsValidMouseButton(button) && mouseButtons[button] && !previousMouseButtons[button]; }

bool Core::InputManager::IsMousePressed(const std::string &buttonAlias) const { return IsMousePressed(GetKeyFromName(buttonAlias)); }

bool Core::InputManager::IsMouseReleased(const int button) const { return IsValidMouseButton(button) && !mouseButtons[button] && previousMouseButtons[button]; }

bool Core::InputManager::IsMouseReleased(const std::string &buttonAlias) const { return IsMouseReleased(GetKeyFromName(buttonAlias)); }
