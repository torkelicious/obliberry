...
int InputManager::GetKeyFromName(const std::string &keyName) {
    static const std::unordered_map<std::string, int> keyMap = {
        ...
        // Numpad
        {"Num0", GLFW_KEY_KP_0}, {"Num1", GLFW_KEY_KP_1}, {"Num2", GLFW_KEY_KP_2},
        {"Num3", GLFW_KEY_KP_3}, {"Num4", GLFW_KEY_KP_4}, {"Num5", GLFW_KEY_KP_5},
        {"Num6", GLFW_KEY_KP_6}, {"Num7", GLFW_KEY_KP_7}, {"Num8", GLFW_KEY_KP_8},
        {"Num9", GLFW_KEY_KP_9},
