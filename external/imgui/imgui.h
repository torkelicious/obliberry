...
enum ImGuiMultiSelectFlags_ {
    ...
    ImGuiMultiSelectFlags_SelectOnMask_ = ImGuiMultiSelectFlags_SelectOnAuto | ImGuiMultiSelectFlags_SelectOnClickAlways
...
struct ImDrawList {
    ...
    // Obsolete names
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    inline void AddRect(const ImVec2 &p_min, const ImVec2 &p_max, ImU32 col, float rounding, ImDrawFlags flags,
                        float thickness) { AddRect(p_min, p_max, col, rounding, thickness, flags); }

    // OBSOLETED in 1.92.8: NEW FUNCTION SIGNATURE HAS 'thickness' AND 'flags' SWAPPED.
    inline void AddPolyline(const ImVec2 *points, int num_points, ImU32 col, ImDrawFlags flags, float thickness) {
...
struct ImFontAtlas {
    ...
    IMGUI_API ImFontAtlasRectId AddCustomRectFontGlyphForSize(ImFont *font, float font_size, ImWchar codepoint, int w,
                                                              int h, float advance_x,
                                                              const ImVec2 &offset = ImVec2(0, 0));
